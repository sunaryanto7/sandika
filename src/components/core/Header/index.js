        ...
        <>
            <div className={theme.header}>
                ...
                <div className={theme.header__content}>
                    ...
                    {/* Sidebar Icon */}
                    {(!withNavigation && <div className={theme.nav}>
                    ...
                    {/* App Name */}
                    {(withAppName && <div className={theme.app__name}>
                        <h1 onClick={() => { Router.push('/'); }}>{t('core:Sandika')}</h1>
                    </div>)}

                    {/* Minicart */}
                    {(withMinicart && <div className={theme.minicart__block}>
